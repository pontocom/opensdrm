...
include_once($_SERVER["DOCUMENT_ROOT"].$GLOBALS["LIB_DIR"]."/adodb/adodb.inc.php");
...
class DatabaseHandler
{
	...
	/**
     * DEPRECATED!!!!
     * Use Connect instead (because of better name similarity
     * with ADOdb) -> NOTE THE PARAMETERS CHANGE!!!!
     *
	...
	/**
     * DEPRECATED!!!!
     * Use Execute instead (because of better name similarity
     * with ADOdb)
     *
