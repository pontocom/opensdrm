...
include_once("/Users/carlosserrao/Sites/opensdrmsf/server/drm/config.inc.php");
include_once("../configCFS.inc.php");
include_once("/Users/carlosserrao/Sites/opensdrmsf/server/drm/lib/common/openssl/X509Certificate.class.php");
