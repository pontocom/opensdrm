...
<p align="center"><a href="cfsManagerDo.php?what=logout" class="logout">Logout</a></p>

<?php
	$cfs_admin = new CFS_Administrator();
	$servers = $cfs_admin->listServers_();
?>
...
<td>
<a href="cfsManagerDo.php?what=remove&ctype=<?php echo $servers[$n]; ?>">Remove</a>
</td>
</tr>
<?php
	}
...
<form action="cfsManagerDo.php" method="POST" name="ncform">
