...
<link rel="stylesheet" href="cps_admin.css" type="text/css"></head>
<body bgcolor="#F6F5AC"> 
<?php
if(!isset($_REQUEST['op']) || $_REQUEST['op']=="MAIN") {
	...
	if(!isset($_REQUEST['login_status']) || $_REQUEST['login_status']!="ON") {
		include_once("../business/CPS_Administrator.class.php");
		$admin = new CPS_Administrator();
