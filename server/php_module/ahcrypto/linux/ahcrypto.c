...
PHP_FUNCTION(ahrsa_create_keys)
{
	...
	internal_rsa_create_keys(size, &n_dat, &n_len, &e_dat, &e_len, &d_dat, &d_len,
	                                               &p_dat, &p_len, &q_dat, &q_len, ahmalloc);
...
PHP_FUNCTION(ahrsa_cipher)
{
	...
	internal_rsa_cipher(clear_data, clear_data_len, n_dat, n_len, e_dat, e_len, &cryptogram, &cryptogram_len, ahmalloc);
...
PHP_FUNCTION(ahaes_cipher)
{
	...
	internal_aes_cipher(clear_data, clear_data_len, k_dat, k_len, &cryptogram, &cryptogram_len, ahmalloc);
